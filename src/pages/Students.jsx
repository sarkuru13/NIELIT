    ...
    <>
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-md">
            <div className="relative">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                <input type="text" placeholder="Search by name or ABC ID..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg focus:ring-indigo-500 focus:border-indigo-500" />
            </div>
                ...
                {(modalContent === 'add' || modalContent === 'edit') && (
                  <form onSubmit={handleFormSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div><label className="block text-sm font-medium">Name</label><input type="text" name="Name" value={formData.Name || ''} onChange={e => setFormData({...formData, Name: e.target.value})} className="w-full mt-1 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg" required /></div>
                        <div><label className="block text-sm font-medium">ABC ID</label><input type="number" name="ABC_ID" value={formData.ABC_ID || ''} onChange={e => setFormData({...formData, ABC_ID: e.target.value})} className="w-full mt-1 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg" required /></div>
                        <div><label className="block text-sm font-medium">Gender</label><select name="Gender" value={formData.Gender || ''} onChange={e => setFormData({...formData, Gender: e.target.value})} className="w-full mt-1 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg" required><option value="">Select</option><option>Male</option><option>Female</option><option>Other</option></select></div>
                        ...
                        <div><label className="block text-sm font-medium">Course</label><select name="Course" value={formData.Course || ''} onChange={e => setFormData({...formData, Course: e.target.value})} className="w-full mt-1 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg" required><option value="">Select</option>{courses.map(c => <option key={c.$id} value={c.$id}>{c.Programme}</option>)}</select></div>
                        <div><label className="block text-sm font-medium">Semester</label><input type="number" name="Semester" value={formData.Semester || ''} onChange={e => setFormData({...formData, Semester: e.target.value})} className="w-full mt-1 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg" /></div>
                        <div><label className="block text-sm font-medium">Batch</label><input type="number" name="Batch" value={formData.Batch || ''} onChange={e => setFormData({...formData, Batch: e.target.value})} className="w-full mt-1 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg" /></div>
                        
                        {/* MODIFIED PART */}
                        <div>
                          <label className="block text-sm font-medium">Year</label>
                          <select name="Year" value={formData.Year || ''} onChange={e => setFormData({...formData, Year: e.target.value})} className="w-full mt-1 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg">
                    ...
                    <div><label className="block text-sm font-medium">Address</label><textarea name="Address" value={formData.Address || ''} onChange={e => setFormData({...formData, Address: e.target.value})} className="w-full mt-1 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg" rows="3"></textarea></div>
